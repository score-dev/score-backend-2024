...
public class HomeGroupInfoResponse {
    ...
    public HomeGroupInfoResponse(Long groupId, String groupName, int numOfMembers, List<String> todayExercisedMatesImgUrl, List<HomeNotExercisedUserResponse> notExercisedUsers) {
